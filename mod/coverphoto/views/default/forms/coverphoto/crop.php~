...
<div class="clearfix">
	<?php echo $master_img; ?>
	<div id="user-avatar-preview-title"><label><?php echo elgg_echo('coverphoto:preview'); ?></label></div>
	<div id="coverphoto-preview"><?php echo $preview_img; ?></div>
</div>
<div class="elgg-foot">
<?php
...
echo elgg_view('input/submit', array('value' => elgg_echo('coverphoto:create')));
