...
.elgg-menu-site-default > li:hover > a {
	background: #c0151b;
	color: #fff;	/* Safari 4-5, Chrome 1-9 */
}
...
.elgg-menu-page {
	...
	background: #e71c23;
	/* Safari 4-5, Chrome 1-9 */
	background: -webkit-gradient(linear, 0% 0%, 0% 25%, from(#aaa), to(#bbb));
	/* Safari 5.1, Chrome 10+ */
...
.elgg-menu-page a:hover {
	...
	color: white;	/* Safari 4-5, Chrome 1-9 */
	/* Safari 4-5, Chrome 1-9 */
...
.elgg-menu-owner-block {
	...
	background: #e71c23;
	/* Safari 4-5, Chrome 1-9 */
	background: -webkit-gradient(linear, 0% 0%, 0% 25%, from(#aaa), to(#ddd));
	/* Safari 5.1, Chrome 10+ */
...
.elgg-menu-owner-block li.elgg-state-selected > a {
	background-color: #4690D6;
	/* Safari 4-5, Chrome 1-9 */
	background: -webkit-gradient(linear, 0% 0%, 0% 25%, from(#c0151b), to(#f01d25));
	/* Safari 5.1, Chrome 10+ */
	background: -webkit-linear-gradient(top, #f01d25, #c0151b);
	/* Firefox 3.6+ */
	background: -moz-linear-gradient(top, #f01d25, #c0151b);
	/* IE 10 */
	background: -ms-linear-gradient(top, #f01d25, #c0151b);
	/* Opera 11.10+ */
	background: -o-linear-gradient(top, #f01d25, #c0151b);
